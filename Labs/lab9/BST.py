...
class BinarySearchTree:
    ...
    def height(self) -> int:
        ...
        if self.is_empty():
            #Use empty tree as a base case since all binary trees end at a base case
            return 0
    ...
    def items_in_range(self, start: Any, end: Any) -> list:
        ...
        if self.is_empty(): #Very important base case
            return []
    ...
    def rotate_right(self) -> None:
        ...
        # Update the new right subtree of the new root
    ...
    def rotate_left(self) -> None:
        ...
        self._root, self._left, self._right = self._right._root, new_left, self._right._right


def Binary_Search(lst: list, item: int) -> bool:
